...
## P4-D presentation record

Settings schema v4 serializes exactly `presentation.density`, `presentation.skin`, and
`presentation.color_scheme`. Fresh defaults select System. v1 migrates to
Comfortable+Refined+Dark, v2 retains density and adds Refined+Dark, v3 retains
