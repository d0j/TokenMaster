...
| TM-FUNC-010 | partial | strict provider-neutral benefit lots, Codex reset-credit normalization, schema-v11 inventory/history/profile/due storage; query/reminder runtime/UI and activation later | domain/pure reconciliation/Codex privacy/store migration-write-retention-fault fixtures pass; immutable query and one-timer delivery remain next |
...
| TM-PERF-001 | partial | bounded parser/reader/store/engine plus live usage/quota runtimes, query facade, and short-lived Codex quota transport | prior gates plus quota scale at 32 windows, 1,000 transitions, and 10,000 duplicate polls; maximum visible write 3.429 ms, duplicate 0.228 ms, current-32 2.774 ms, history-256 1.256 ms; live Codex polls completed in 0.70-0.94 seconds, transport resources plateau, and full runtime success/RPC/timeout/busy/pause-resume cycles plateau after 16 warm-up plus 48 measured rounds at 3.15-MiB retained floor/5.62-MiB sampled high, 131 handles, four threads, USER=1, GDI=0; UI/plugin release evidence pending |
...
| TM-DATA-009 | partial | typed provider benefit inventory, pure reconciliation/reminder planning, built-in Codex normalization, strict schema-v11 current/history/profile/due/delivery foundation; activation later | exact-expiry and aggregate-unknown lots, privacy, v10 migration, duplicate/freshness/missing/reappearance/terminal cursor, override/default profile, 512/256 soft retention, 2,048/1,024 hard bounds, 256-row maintenance, restart, and injected rollback contracts pass; immutable reads, delivery runtime, UI, intents/receipts remain |
