...
| TM-PERF-001 | partial | parser, reader, domain, store bounds, P0-E composition, and complete P1-C engine core | 300-file/300-event, streamed discovery with no source list, 256 observation/relation batches, 256 replay-source pages, 32-KiB checkpoints, 18 chunk updates, 4,096 continuation cap, reopen, capacity-one wake/result channels, and 10,000-hint one-follow-up contracts pass; live/query/plugin runtime evidence pending |
...
| TM-DATA-006 | partial | reader/parser/store plus engine value/batch/page/execution/worker limits | line/resume, 32-KiB opaque checkpoint, 256 batch/page, 18 chunk-update, 4,096 continuation, fixed-result, one active/aggregate follow-up, capacity-one channels, and SQLite-i64 counter bounds; full UI/query/plugin limits pending |
...
shutdown/Drop ownership. P1-D live Codex composition and the real OS writer lease are
next.
