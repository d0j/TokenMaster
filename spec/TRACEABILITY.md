...
| TM-FUNC-004 | partial | exact joined product status, immutable reducer, P3-A-P3-B live shell, P3-C Dashboard, P3-D.1 History, complete P3-D.2 Sessions, P3-D.3 Models, P3-D.4 Projects, P3-D.5 Activity, P3-D.6 Notifications, and P3-D.7 Help/About | prior evidence plus responsive bounded data routes and an archive-independent fixed Help/About guide with compile-time version and honest deferred-capability truth; visible notification delivery/settings and P3-E shell integration remain |
...
| TM-UI-001 | partial | P3-A shell, P3-C responsive Dashboard, P3-D.1 History, P3-D.2 Sessions list/detail, P3-D.3 Models, P3-D.4 Projects, P3-D.5 Activity, P3-D.6 Notifications, and P3-D.7 Help/About | prior evidence plus a wide/narrow six-section accessible guide covering source/privacy/recovery/automation/license truth and one standard Slint attribution surface; unified localization and full interactive accessibility acceptance remain P4/P6 |
| TM-UI-002 | partial | immutable runtime/query/product publication plus bounded data-route application and static Help/About | epoch/newer-generation replacement includes capped data models; Help/About has no model/projection and receives one compile-time version at window construction; route-only updates perform no query/model rebuild/window recreation/timer/animation/delivery acknowledgement; hot skin/locale/layout settings remain P4 |
| TM-PERF-001 | partial | bounded backend, one-current product/Desktop projection, bounded workers/event gates, capped data models, and static Help/About | prior gates plus bounded Notifications and a six-section Help/About with zero model/query/runtime/polling ownership and no route-time allocation; measured visible-paint and long-run release evidence remain P4/P6 |
...
| TM-DATA-001 | partial | prior privacy boundaries plus path-private app root, bounded data models, and static Help/About | Help/About explicitly excludes content, credentials, paths, private identities, raw errors, dynamic diagnostics, and release state while adding no data model; remaining P3-E-P5 surfaces repeat gates |
...
| TM-DATA-006 | partial | prior bounded publication plus current data projections and static Help/About | prior caps remain; Help/About adds six fixed sections, one compile-time string, no row model/query/cache, and position-only wide/narrow reflow; later pagination, rhythm aggregates, and P4 switch limits remain |
...
| TM-SEC-002 | partial | prior strict boundaries plus separate app/frontend authority and privacy-bounded data/reliable-state UI and P3-D.7 Help/About | Help/About has one compile-time version setter, one standard pinned attribution widget, six fixed sections, and zero model/query/runtime/callback/polling/product-URL authority; P3-E-P5/plugin and interactive accessibility suites remain |
