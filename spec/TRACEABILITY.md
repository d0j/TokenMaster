...
| TM-REL-003 | partial | P3-D.7 standard pinned Slint attribution surface plus P6 explicit MSVC signed portable package and supply-chain gates | in-product attribution exists; the canonical MSVC toolchain is provisioned and its exact x64 Windows-GUI release binary passes static-runtime validation. Generated notices/SBOM, public-download attribution, signing, advisory/source/license/secret/action/attestation audits, deterministic package and accepted clean-room launch remain pending |
