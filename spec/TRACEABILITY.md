...
| TM-REL-003 | partial | P3-D.7 attribution, P6 MSVC package, and bounded supply-chain gates | in-product attribution, canonical MSVC binary, deterministic unsigned nine-file ZIP, notices, SBOM, and exact-commit GitHub Actions references pass. Public-download attribution, signing, advisory/source/license/secret/attestation audits, authenticated clean-room launch, interactive matrix, performance comparison, and soak remain pending |
