...
| TM-REL-001 | partial | M0 scripts, product receipt schemas, and separate P3-D.0 developer receipt | historical schema-1 P3-D.0 clean-commit/executable identity checks pass; a current schema-3 exact-commit receipt and final product packaging evidence remain pending |
