...
| TM-PERF-003 | partial | keyset store reads, immutable engine publication, and P2-A bounded schema-v1 query values | P1-E plus P2-A checked identity/envelope/page/privacy contracts pass; exact query transaction/index/deadline/resource contracts pending |
