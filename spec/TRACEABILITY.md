...
| TM-DATA-007 | partial | replay facts/classifier in a private overlay plus schema-v4 self-contained canonical projection with deterministic selection/retention | v1/v2/v3-to-v4 migration plus replay/append/restart/300-file/atomic-replacement/truncation truth-table/failure contracts pass; a clean real-archive smoke published current-day partial data after 70 sources with bounded memory, while replacement staging remains private until exact-scan resume and atomic promotion; complete large-import acceptance remains open |
