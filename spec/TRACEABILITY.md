...
| TM-FUNC-007 | partial | accounting lineage/classifier, scalable replay archive, P0-E composition, and P1-A retention | synthetic JSONL baseline/append/restart/replay/quality/atomic-replacement/truncation-retention/failure contracts pass; real large first-import data exposes an unresolved published-partial/resumable-recovery contour, so no release claim is allowed |
...
| TM-UI-001 | partial | complete bounded data routes, static Help/About, P3-E.1 command palette, P3-E.2 compact quota mode, P3-E.3 tray lifecycle, P3-E.4 Show/restore/focus activation, P3-E.5 startup-status/actions, transient accessible expiry panel, P4-G locale projections, first-safe-import Dashboard status, and bounded route viewports | compiled Slint proves palette/compact activation, an in-main-window phase-changing loading status with reduced-motion-aware activity dots, en/ru/pseudo labels with stable query keys, and a dispatched pointer-wheel event that moves Sessions content; live Windows focus/accessibility/sign-in and interactive locale acceptance remain P4/P6 |
