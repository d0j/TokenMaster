...
| TM-REL-003 | partial | P3-D.7 attribution, P6 MSVC package, and bounded supply-chain gates | in-product attribution, canonical MSVC binary, deterministic unsigned nine-file ZIP, notices, SBOM, exact-commit GitHub Actions references, and pinned-tool advisory/license/source policy pass. Public-download attribution, secret scan, artifact attestation, signing, authenticated clean-room launch, interactive matrix, performance comparison, and soak remain pending |
