...
| TM-FUNC-012 | planned | P3-D.0 `tokenmaster-state` plus store/platform/app integration | approved reliable-state design and 18-task TDD plan; settings/package/snapshot/retention/recovery/safe-mode evidence pending |
...
| TM-SEC-008 | planned | strict imported-package validation, fixed writer identity, staged replacement, and quarantine | compression/encryption abuse, main/WAL/SHM, no-false-authority, privacy, dependency, and release-binary audits pending |
