...
| TM-FUNC-011 | partial | strict Git domain/core/backend/hints, schema-v13 transactional projection, and immutable public query/efficiency facade | Tasks 1-6 domain/aggregate/process/synthetic/privacy/schema/migration/rebuild/append/refresh/invalidation/store-query/public-envelope/exact-join/32x400 contracts pass; runtime scheduling/resource evidence, joined status, and UI remain |
