...
| TM-FUNC-007 | partial | accounting lineage/classifier plus scalable P0-D/P0-D.1 replay archive lifecycle implemented | schema-v3 migration, all-source begin, 300-source lifecycle, seal/promotion/rollback contracts pass; P0-E cross-crate proof remains |
...
| TM-DATA-004 | implemented | atomic current append, SQLite-owned all-source staging, paged exact seal, rollback-safe promotion, and staging discard | migration/fault/all-source/300-source/lifecycle/rollback contracts pass |
...
| TM-DATA-007 | partial | replay facts/classifier persisted in a strict v3 private overlay with deterministic selection, bounded reconciliation, seal, and promotion | v1/v2/v3 migration, read/append/relation/restart/keyset/cycle/missing-complete/300-source/promotion contracts pass; P0-E end-to-end proof remains |
...
| TM-SEC-004 | partial | transactional CAS, immutable legacy, exact paged seal, atomic promotion, migration/promotion injected rollback, and exact-epoch staging discard implemented | archive mutation/recovery/scalable-manifest contracts pass; P0-E proves failed/cancelled cross-crate behavior and P1 owns runtime policy |
...
256-row keyset-paged validation. P0-E transactional Codex-to-archive proof is next;
the production runtime engine remains P1.
