...
| TM-FUNC-007 | partial | accounting lineage, Codex ancestry, and pure classifier implemented; store replay pending | P0-A through P0-C contracts pass; P0-D/P0-E remain |
...
| TM-DATA-007 | partial | replay identity/evidence, Codex ancestry, and pure classifier implemented | classifier contracts pass; P0-D/P0-E archive/pipeline tests pending |
