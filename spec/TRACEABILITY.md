...
| TM-PERF-002 | open evidence | software renderer and M0 resource gates | the software-pixel startup frame is non-black/non-uniform, but the available Windows capture remains black; trustworthy physical paint, uninterrupted soak, and interactive receipts remain absent |
