...
- [x] **Step 1: Write failing global replacement tests**
...
- [x] **Step 3: Implement the bounded transaction**
...
- [x] **Step 4: Add RED edge tests and make GREEN**
...
- [x] **Step 1: Write failing projection/intent tests**
...
- [x] **Step 3: Implement fixed-cap values**
...
- [x] **Step 1: Write RED state tests**
...
- [x] **Step 3: Implement settings-first desired state**
...
- [x] **Step 4: Project exact state and run GREEN**
...
- [x] **Step 1: Write RED command/lifecycle tests**
...
- [x] **Step 1: Write RED real-UI tests**
...
- [x] **Step 4: Implement exact Rust mapping**
...
- [x] **Step 5: Run GREEN and package tests**
...
- [x] **Step 1: Add RED audit mutations**
...
- [x] **Step 2: Run RED then implement computed receipts**
...
- [x] **Step 3: Synchronize documentation**
...
- [x] **Step 4: Focused verification and independent review**
...
- [x] **Step 6: Commit synchronized evidence and prove clean state**
