...
| note | A full-width marker cannot tell "fits" from "clipped" -- both end on the last pixel. This produced one wrong reading here before the marker was given a visible right end. | measurement technique |
