...
fn combine_legacy_update_trigger(name: &str, delete_trigger: &str, insert_trigger: &str) -> String {
...
fn restore_v12_time_triggers(connection: &Connection) {
    ...
    connection
        ...
        .expect("drop current time triggers");
    connection
        .execute_batch(include_str!(
            "../../store/tests/fixtures/usage_v13_time_delete_triggers.sql"
        ))
        .expect("restore v12 time delete triggers");
    ...
    connection
        .execute_batch(&combine_legacy_update_trigger(
            "usage_event_aggregate_time_after_update",
            &aggregate_delete,
            &aggregate_insert,
        ))
        .expect("restore v12 aggregate time update trigger");
    connection
        .execute_batch(&combine_legacy_update_trigger(
        ...
        .expect("restore v12 price time update trigger");
}
